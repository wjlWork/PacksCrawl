...
{
    public class PacksContainer_Statistical
    {
        public PacksListConfig_Statistical Lc { get; set; }
        ...
        public PacksContainer_Statistical(string url, PacksListConfig_Statistical lc)
        {
            this.ListUrl = url;
            this.Lc = lc;
        ...
        //获得全部列表页面的礼包URL
        private List<string> allPackUrl(string url, PacksListConfig_Statistical config)
        {
            //第一页
        ...
        //获得一个列表页面的礼包URL
        private List<string> GetPackUrls(string url, PacksListConfig_Statistical config)
        {
            List<string> ls = new List<string>();
            //获得页面源码
            HtmlNodeCollection nodes = HtmlAgilityPackHelper.GetHtmlNodes(url, config.PacksListUrlsXpath);
            if (nodes != null)
            {
        ...
        /// <returns></returns>
        private static string NextPage(string a_PageUrl, PacksListConfig_Statistical config)
        {
            //下一页
            string Variable = "";
            string nextPage = null;
            HtmlNodeCollection nodes = HtmlAgilityPackHelper.GetHtmlNodes(a_PageUrl, config.NextPageUrlXpath);
